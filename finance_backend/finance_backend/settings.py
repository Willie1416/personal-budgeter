...
SECRET_KEY = 'django-insecure-kqvz$_%lep4m4$4k2wyce8u)(4436qia97i7)o6=-si9$^x!-k'
...
CSRF_COOKIE_HTTPONLY = False  # Default is False, ensures the cookie can be read by JavaScript
